...
map_file_path = r"C:\Users\S HITESH\PycharmProjects\pythonProject2\GetControlPoints\map.p"
countries_file_path = r"C:\Users\S HITESH\PycharmProjects\pythonProject2\GetCountryPolygon\countries.p"
######################################
...
def get_finger_location(img,imgWarped):
    ...
    if hands:
        ...
        cv2.circle(imgWarped, warped_point, 4, (255, 0, 0), cv2.FILLED)
    else:
        warped_point = None
...
while True:
    ...
    #imgStacked = cvzone.stackImages([img, imgWarped,img,imgOverlay], 2, 0.3)
